...
public class ImportExamDtoValidatorTests
{
    ...
    {
        ImportExamDto dto = new() { Title = "", Questions = new List<ImportQuestionDto>() };
    ...
    {
        ImportExamDto dto = new() { Title = new string('A', 501), Questions = new List<ImportQuestionDto>() };
        TestValidationResult<ImportExamDto>? result = _validator.TestValidate(dto);
        result.ShouldHaveValidationErrorFor(x => x.Title);
    }
    ...
    {
        ImportExamDto dto = new() { Title = "Valid Title", Questions = new List<ImportQuestionDto>() };
        TestValidationResult<ImportExamDto>? result = _validator.TestValidate(dto);
    ...
    public void Should_Have_Error_When_SingleChoiceToShow_Is_Negative()
    {
        ...
        {
            Title = "Valid Title", Questions = new List<ImportQuestionDto>(), SingleChoiceToShow = -1
        };
        TestValidationResult<ImportExamDto>? result = _validator.TestValidate(dto);
